package sh.idktheflag.idk.impl.gui.components.module;
...
import sh.idktheflag.idk.impl.gui.components.value.*;
...
import sh.idktheflag.idk.api.gui.widget.impl.BindWidget;

...
import sh.idktheflag.idk.api.management.*;
import sh.idktheflag.idk.api.management.accounts.Accounts;
import sh.idktheflag.idk.api.management.breaks.BreakManager;
import sh.idktheflag.idk.api.management.notification.NotificationManager;
import sh.idktheflag.idk.api.management.shaders.ShaderManager;
import sh.idktheflag.idk.impl.features.commands.*;
import sh.idktheflag.idk.impl.features.hud.*;
import sh.idktheflag.idk.impl.features.modules.client.*;
import sh.idktheflag.idk.impl.features.modules.client.gui.*;
import sh.idktheflag.idk.impl.features.modules.combat.*;
import sh.idktheflag.idk.impl.features.modules.ghost.AutoRetotem;
import sh.idktheflag.idk.impl.features.modules.ghost.FastAnchor;
import sh.idktheflag.idk.impl.features.modules.ghost.FastMechs;
import sh.idktheflag.idk.impl.features.modules.ghost.LegitCrystal;
import sh.idktheflag.idk.impl.features.modules.misc.*;
import sh.idktheflag.idk.impl.features.modules.misc.autobreak.AutoBreak;
import sh.idktheflag.idk.impl.features.modules.movement.*;
import sh.idktheflag.idk.impl.features.modules.movement.timer.Timer;
import sh.idktheflag.idk.impl.features.modules.player.*;
import sh.idktheflag.idk.impl.features.modules.render.*;
import sh.idktheflag.idk.impl.features.modules.render.fader.FadeRenderer;
...
//        FeatureManager.INSTANCE.getFeatures().add(new OtherGui());
        ...
        FeatureManager.INSTANCE.getFeatures().add(new EntityLogger());
        FeatureManager.INSTANCE.getFeatures().add(new MapDownloader());
        FeatureManager.INSTANCE.getFeatures().add(new BookBot());
        FeatureManager.INSTANCE.getFeatures().add(new SignBot());

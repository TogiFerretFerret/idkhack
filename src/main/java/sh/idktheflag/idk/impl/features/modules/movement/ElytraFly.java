...
import sh.idktheflag.idk.impl.features.modules.client.Baritone;
...
public class ElytraFly extends Module
{
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent.Pre event)
    {
        ...
        if (IdkHackMod.BARITONE_AVAILABLE)
        {
            ...
            if (IdkHackMod.isBaritonePaused()) return;
        }
...
//        }
    ...
    {
        return "ElytraFly: I just flew 300 blocks (like a butterfly this time) thanks to idkgod.cc";
    }
}
...
import sh.idktheflag.idk.api.event.events.move.SneakEvent;
    ...
    public void draw(RenderGameOverlayEvent.Text event)
    {
        ...
        switch (blockCounter.getValue())
        {
            case "Bar":
                ...
                event.getContext().fill((int) (x - half), (int) y, (int) ((x - half) + width * percentage), (int) (y + thickness), barColor.getValue().equals("Scissor") ? Color.RED.getRGB() : leftColor.getValue().getColor().getRGB());

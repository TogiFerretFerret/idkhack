...
import sh.idktheflag.idk.api.utils.targeting.EntityTargeter;
import sh.idktheflag.idk.api.utils.targeting.Sorting;
...
public class AimAssist extends Module {
    ...
    public void onRenderWorld(RenderWorldEvent event)
    {
        ...
        if (onlySword.getValue() && !(sh.idktheflag.idk.api.utils.players.InventoryUtils.isSword(mc.player.getMainHandStack().getItem())
                || mc.player.getMainHandStack().getItem() instanceof net.minecraft.item.AxeItem
                || mc.player.getMainHandStack().getItem() instanceof net.minecraft.item.MaceItem)) {
            return;
        }

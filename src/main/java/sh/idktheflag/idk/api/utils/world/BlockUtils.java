...
import sh.idktheflag.idk.api.management.HitboxManager;
...
public class BlockUtils implements IMinecraft
{
    ...
    public static boolean placeBlock(BlockPos pos, Direction direction, Hand hand, boolean packet, boolean swing)
    {
        ...
        {
            PacketManager.INSTANCE.sendPacket(new net.minecraft.network.packet.c2s.play.PlayerInputC2SPacket(new net.minecraft.util.PlayerInput(mc.player.input.playerInput.forward(), mc.player.input.playerInput.backward(), mc.player.input.playerInput.left(), mc.player.input.playerInput.right(), mc.player.input.playerInput.jump(), true, mc.player.input.playerInput.sprint())));
        ...
        if (packet)
        {
            ...
            if (unShift)
                PacketManager.INSTANCE.sendPacket(new net.minecraft.network.packet.c2s.play.PlayerInputC2SPacket(new net.minecraft.util.PlayerInput(mc.player.input.playerInput.forward(), mc.player.input.playerInput.backward(), mc.player.input.playerInput.left(), mc.player.input.playerInput.right(), mc.player.input.playerInput.jump(), false, mc.player.input.playerInput.sprint())));

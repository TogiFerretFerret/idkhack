package sh.idktheflag.idk.api.utils.chat;

import sh.idktheflag.idk.api.utils.NullUtils;
import sh.idktheflag.idk.api.utils.ducks.IChatHud;
...
public class ChatUtils implements IMinecraft
{
    ...
    public static String CLIENT_NAME = Formatting.BLUE + "[" + Formatting.AQUA + IdkHackMod.NAME + Formatting.BLUE + "]" + Formatting.RESET;
    ...
    public static void sendMessage(ChatMessage message)
    {
        ...
        CLIENT_NAME = Manager.INSTANCE.getAccent() + "[" + Manager.INSTANCE.getMainColor() + IdkHackMod.NAME + Manager.INSTANCE.getAccent() + "]" + Formatting.RESET;

package sh.idktheflag.idk.api.utils.render.world.buffers;
...
public class RenderBuffers {
    ...
    private static final RenderLayer QUADS_LAYER = RenderLayer.of("idk_quads",
            RenderSetup.builder(RenderPipelines.DEBUG_QUADS).build());
    private static final RenderLayer LINES_LAYER = RenderLayer.of("idk_lines",
            RenderSetup.builder(RenderPipelines.LINES).build());
    private static final RenderLayer DEBUG_LINES_LAYER = RenderLayer.of("idk_debug_lines",
            RenderSetup.builder(RenderPipelines.LINES).build());
    private static final RenderLayer TRIANGLES_LAYER = RenderLayer.of("idk_triangles",

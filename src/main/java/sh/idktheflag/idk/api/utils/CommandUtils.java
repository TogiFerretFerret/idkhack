...
public class CommandUtils implements IMinecraft {
    ...
    {
        File spammerFolder = new File(MinecraftClient.getInstance().runDirectory.getAbsolutePath(), File.separator + "idk" + File.separator + "spammer" + File.separator);
    ...
    {
        File configFolder = new File(mc.runDirectory.getAbsolutePath(), File.separator + "idk" + File.separator + "configs" + File.separator);
    ...
    {
        File chams = new File(mc.runDirectory.getAbsolutePath(), File.separator + "idk" + File.separator + "chams" + File.separator);

package sh.idktheflag.idk.api.feature;
...
import sh.idktheflag.idk.api.utils.render.animation.type.ConsistentDynamicAnimation;
...
//        }
    ...
    {
        animationIcky();
        IdkHackMod.EVENT_BUS.unregister(this);
    }
            ...
            if (o != null)
            {
                try
                {
                    if (value.getValue() instanceof IdkColor)
                    {
                        ...
                        IdkColor idkColor = new IdkColor(new Color((int) map.get("red"), (int) map.get("green"), (int) map.get("blue"), (int) map.get("alpha")), (boolean) map.get("sync"));
                        value.setValue(idkColor);
                    } else
                    {
                        value.setValue(o);
                    }

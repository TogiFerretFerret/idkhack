package sh.idktheflag.idk.api.gui;
...
import sh.idktheflag.idk.api.gui.misc.SearchBar;
...
public class GUI extends Screen implements IMinecraft {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float delta)
    {
        ...
        Fonts.renderText(drawContext, "idk " + IdkHackMod.VERSION + " by Skitttyy + (" + IdkHackMod.HASH + ")", 3, context.getScaledResolution().getScaledHeight() - 12, ColorUtil.newAlpha(Color.WHITE, 100), true);

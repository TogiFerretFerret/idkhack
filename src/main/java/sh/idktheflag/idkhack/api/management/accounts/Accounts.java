package sh.idktheflag.idkhack.api.management.accounts;

import sh.idktheflag.idkhack.api.config.ISavable;
import sh.idktheflag.idkhack.api.management.accounts.types.CrackedAccount;
import sh.idktheflag.idkhack.api.management.accounts.types.MicrosoftAccount;
...
public class Accounts implements ISavable, Iterable<Account<?>> {
    ...
    private void saveConfig() {
        try {
            if (sh.idktheflag.idkhack.api.management.SavableManager.INSTANCE != null) {
                sh.idktheflag.idkhack.api.management.SavableManager.INSTANCE.save();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

package sh.idktheflag.idkhack.api.feature.module;

import sh.idktheflag.idkhack.api.gui.font.Fonts;
import sh.idktheflag.idkhack.api.management.BindManager;
...
import sh.idktheflag.idkhack.api.value.custom.Bind;
...
//        {
//            IdkHackMod.notificationProcessor.addNotification(Formatting.RESET + getDisplayName() + Formatting.WHITE + " was " + Formatting.GREEN + "enabled" + Formatting.WHITE + ".", 500L);
//        }
